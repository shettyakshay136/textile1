            ...
            <div id='orders PAGE'className='place-items-start lg:place-items-start md:place-items-start min-[250px]:place-items-center relative p-7 w-[900px] lg:w-[900px] md:w-[900px] min-[250px]:w-[500px]'>
                ...
                <div className=' bg-[#F0F8FF] flex-col p-4 rounded-[20px] shadow-xl'>
                    ...
                    <div className='grid grid-cols-1 pt-2 pl-6 pr-6 pb-1'>
                        <div className='flex lg:flex-row md:flex-row min-[250px]:flex-col items-start gap-[10rem] lg:gap-[10rem] md:gap-[10rem] min-[250px]:gap-[1rem] p-2 pb-2'>
                            <label htmlFor='field1' className=''>Username:</label>
                        ...
                        <div className='flex lg:flex-row md:flex-row min-[250px]:flex-col items-start gap-[10.3rem] p-2 pb-2 lg:gap-[10rem] md:gap-[10rem] min-[250px]:gap-[1rem]'>
                            <label htmlFor='field1' className=''>Password:</label>
                            <div className=''>
                                <input type='text' id='field1' className='rounded-[5px] border border-black outline-none bg-transparent  p-1' />
                        ...
                        <div className='flex lg:flex-row md:flex-row min-[250px]:flex-col items-start gap-[4.2rem] p-2 pb-2 lg:gap-[4.2rem] md:gap-[4.2rem] min-[250px]:gap-[1rem]'>
                            <label htmlFor='field1' className=''>Password confirmation:</label>
                            <div className=''>
                                <input type='text' id='field1' className='rounded-[5px] border border-black outline-none bg-transparent  p-1' />
                                <h4 className='text-[15px]'>Enter the same password as before, for verification.</h4>
                            </div>
                        </div>
                        <div className='items-center flex lg:flex-row md:flex-row min-[250px]:flex-col  justify-center gap-5 pt-1 text-[15px] lg:text-[15px] md:text-[13px] sm:text-[13px] min-[250px]:text-[13px]'>
